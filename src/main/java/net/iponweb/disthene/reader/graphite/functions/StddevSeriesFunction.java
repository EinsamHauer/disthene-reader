 ...
 */
public class StddevSeriesFunction extends DistheneFunction {


    public StddevSeriesFunction(String text) {
        super(text, "stddevSeries");
    }
    ...
    public List<TimeSeries> evaluate(TargetEvaluator evaluator) throws EvaluationException {
        ...
        for (int i = 0; i < length; i++) {
            ...
            values[i] = CollectionUtils.stdev(points);
        }
