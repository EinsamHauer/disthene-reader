...
public class AverageSeriesWithWildcardsFunction extends DistheneFunction {
    ...
    public void checkArguments() throws InvalidArgumentException {
        if (arguments.size() != 2)
            throw new InvalidArgumentException("averageSeriesWithWildcards: number of arguments is " + arguments.size() + ". Must be two.");
        ...
        if (!(arguments.get(1) instanceof Double))
            throw new InvalidArgumentException("averageSeriesWithWildcards: argument is " + arguments.get(1).getClass().getName() + ". Must be a number");
    }
}